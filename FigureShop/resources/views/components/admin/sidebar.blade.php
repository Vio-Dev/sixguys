...
<div x-data="{ open: false }" class="text-white">
    <ul>
        ...
        <button @click="open = !open" id="dropProduct"
            class=" text-white font-medium rounded-lg text-sm text-center inline-flex gap-1 p-2 w-full items-center hover:underline hover:bg-gray-700"
            type="button">
        ...
        <div x-show="open" @click.outside="open = false" id="dropdown"
            class=" divide-gray-100 rounded-lg shadow  dark:bg-gray-700  mt-2">
            <ul class="py-2 text-sm text-white-700 dark:text-gray-200" aria-labelledby="dropProduct">
                <li>
                    <a href={{ route('admin.products.list') }}
                        class="block px-4 py-2 hover:bg-gray-700 dark:hover:bg-gray-600 hover:text-dark hover:underline">Danh
                        sách</a>
                </li>
                <li>
                    <a href={{ route('admin.products.create') }}
                        class="block px-4 py-2 hover:bg-gray-700 dark:hover:bg-gray-600 hover:text-dark hover:underline">Tạo
                        mới</a>
                </li>
...
<a href="" class="flex p-2 font-medium gap-1 hover:underline hover:bg-gray-700">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <path fill="currentColor"
