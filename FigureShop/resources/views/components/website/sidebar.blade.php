          ...
          <div class="w-full">
              <div class="flex w-full">
                  <div class="flex flex-col gap-2">
                      <a href="{{ route('ho-so.ho-so') }}" class="flex items-center gap-2 font-medium">
