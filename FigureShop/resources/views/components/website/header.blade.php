<header class="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-5">
    <a href={{ route('home') }} class="flex justify-center items-center">
        <img class="cursor-pointer h-[80px]" src="/image/input.png" alt="company logo" />
        <span class="font-bold text-[24px]">6Guys Figure</span>
    </a>
    ...
    <div class="hidden gap-3 md:!flex">
        <a href="{{ route('ho-so.yeu-thich') }}" class="flex cursor-pointer flex-col items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <a href="{{ route('cart.index') }}" class="flex cursor-pointer flex-col items-center justify-center">
