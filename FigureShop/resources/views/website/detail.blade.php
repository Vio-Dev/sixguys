...
@section('content')
    <section class="container flex-grow mx-auto max-w-[1200px] border-b py-5 lg:grid lg:grid-cols-2 lg:py-10">
        ...
        <div class="container mx-auto px-4">
            <swiper-container style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="detailSwiper_1"
                ...
                <swiper-slide class="swiper__slide">
                    <img class="swiper__slide--img" src="https://swiperjs.com/demos/images/nature-1.jpg" />
                </swiper-slide>
                <swiper-slide class="swiper__slide">
                    <img class="swiper__slide--img" src="https://swiperjs.com/demos/images/nature-2.jpg" />
                </swiper-slide>
                <swiper-slide class="swiper__slide">
                    <img class="swiper__slide--img" src="https://swiperjs.com/demos/images/nature-3.jpg" />
                </swiper-slide>
            </swiper-container>
        ...
        <div class="mx-auto px-5 lg:px-5">
            ...
            <p class="font-bold">
                Danh mục: <span class="font-normal">Sofa</span>
            </p>
            <p class="font-bold">
