...
@section('title', 'Danh sách bình luận bài đăng | FigureShop')

@section('content')
    <div>
        <div class="py-2 ">
            <h2 class="text-[24px] font-bold">Quản lý bình luận bài đăng</h2>
        </div>
        {{-- <div class="py-4">
                ...
                @forelse ($comments as $comment)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap flex gap-2  text-sm font-medium text-left dark:text-white">
                            <form action="{{ route('admin.comments.edit', ['id' => $comment->id]) }}" method="POST"
                                class="inline-block">
                                @csrf
                                @method('PUT')
