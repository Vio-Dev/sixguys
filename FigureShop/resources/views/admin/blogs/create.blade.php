...
@section('content')
    <div>
        ...
        <form action="{{ route('admin.blogs.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                <label for="name" class="block font-medium">Mô tả bài đăng </label>
                <textarea name="description"
                    class="min-h-[800px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">Mô tả bài đăng </textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
