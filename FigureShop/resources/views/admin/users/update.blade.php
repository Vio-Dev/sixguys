...
@section('title', 'Cập nhật người dùng | FigureShop')

@section('content')
    <div class="py-2 ">
        <h2 class="text-[24px] font-bold">Cập nhật người dùng</h2>
    </div>
    <form action={{ route('admin.users.update', ['id' => $user->id]) }} method="POST" enctype="multipart/form-data"
        ...
        <div class="">
            <button type="submit" class="bg-blue-500 p-2 rounded-md text-white">Lưu</button>
